...
import com.zlx.bottombar.util.TintUtil;
import com.zlx.bottombar.widget.MyFragmentTabHost;
...
public class BottomTabBar extends LinearLayout {
    ...
    public BottomTabBar init(FragmentManager manager) {
        ...
        mTabHost = (MyFragmentTabHost) mLayout.findViewById(android.R.id.tabhost);
